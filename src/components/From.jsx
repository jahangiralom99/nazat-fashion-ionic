...
const From = () => {
  ...
  const onSubmit = (data) => {
    ...
    // fetch("http://ecommerce.ionicerp.xyz/api/method/item", {
    //   headers: {
    //     Authorization: "Bearer access_token",
    //   },
    // })
    ...
    fetch("http://ecommerce.ionicerp.xyz/api/method/item", {
      method: "POST",
      headers: {
        Authorization: "token 84859bedced40f4:daa20259bb4c806",
      },
    ...
    <section className="max-w-screen-xl mx-auto px-3 mt-8">
      <div>
        ...
        <p className="text-xl font-extrabold max-w-screen-md mx-auto text-red-500 text-center mt-4 leading-10	">
          আবায়া/বোরকার সাইজ অর্ডার ফর্মে উল্লেখ করে অর্ডার করার অনুরোধ রইলো।{" "}
          <br />
          ছবিতে কালারগুলো ভালোভাবে দেখে পছন্দ করে অর্ডার ফর্মে কালার উল্লেখ করে
          অর্ডার করার অনুরোধ।
        </p>
      </div>
      {/* From starts */}
